...
@section('content')
    ...
    <div style="float: right;color: #fff;" class="col-sm-6 foot_sm">
       Desgin &amp; Development By:<a target="_blank" href="https://deepmarketingsolution.com/"><span style="color: red;">&nbsp;Deep Marketing Solution</span></a>
